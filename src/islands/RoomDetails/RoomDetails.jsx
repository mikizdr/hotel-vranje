...
const RoomDetails = () => {
    ...
    // No client-side router carrying state between pages anymore (this is a
    // plain static page now), so there's no incoming booking selection to
    // read. Every usage below already falls back gracefully when this is
    // undefined.
    const bookingsData = undefined;

    const images = ['/images/inner/room-details-1.jpg', '/images/inner/room-details-2.jpg'];
            ...
            <div className="py-20 2xl:py-[120px] dark:bg-lightBlack">
                    ...
                    <div className="col-span-6 md:col-span-4">
                        ...
                        <div className="pt-5 lg:pt-[35px]  pr-3">
                            ...
                            >
                                ...
                                fabricate extensible infomediaries rather than reliable e-services.
                                Dramatically whiteboard alternative
                            </p>
                            <p
                            ...
                            >
                                ...
                                user-centric vortals. Distinctively seize top-line e-commerce with
                                premier intellectual capital. Efficiently strategize goal-oriented
                            </p>
                ...
                font-Garamond text-[22px] sm:text-2xl md:text-3xl 2xl:text-[32px] leading-7 lg:leading-[26px] text-lightBlack dark:text-white font-semibold"
                                ...
                                <p className="text-sm lg:text-base leading-6 text-gray dark:text-lightGray font-normal font-Lora mb-5 2xl:mb-[30px]">
                                    Applications without seamless data. Uniquely underwhelm quality
                                    outsourcing before transparent relationships. Efficiently
                                    enhance diverse relationships whereas leveraged new house cafe.
                                </p>
