import '../_shared/testimonials.css';
import 'keen-slider/keen-slider.min.css';

import FsLightbox from 'fslightbox-react';
import { useKeenSlider } from 'keen-slider/react';
import { useState } from 'react';
import { BsArrowRight, BsChevronLeft, BsChevronRight, BsPlay, BsTwitter } from 'react-icons/bs';
            ...
            <div className="dark:bg-normalBlack py-20 2xl:py-[120px]">
                <div className="Container">
                    ...
                    <div className="mt-[60px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[30px] ">
                        {/* Member one */}
                        <div className="member group" data-aos="fade-up" data-aos-duration="1000">
                 ...
                 duration-500 left-0 right-0"
                        ...
                        {/* Member two */}
                        <div className="member group" data-aos="fade-down" data-aos-duration="1000">
